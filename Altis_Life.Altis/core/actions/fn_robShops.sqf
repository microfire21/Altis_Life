...
if(_cops < 1) exitWith {hint "You can't rob this register, there aren't any police online! Well Shit!!";};
...
if (vehicle player != _robber) exitWith { hint "Get out of your vehicle dumb shit!" };
if (playerSide == west) exitWIth {cutText["Police don't do this ...","PLAIN"];};
if (_shop distance player > 10) exitWith{ cutText["You must be closer!","PLAIN"];};

if !(_kassa) then { _kassa = 1000; };
if (_rip) exitWith { hint "Robbery already in progress!" };
if (currentWeapon _robber == "") exitWith { hint "You don't threaten me! Piss off before I beat Your ass!" };
